...
export const stylePresets: StylePreset[] = [
  {
    id: "preset-editorial-premium",
    name: "Editorial Premium",
    description: "Sophisticated layouts with restrained contrast, refined typography, and elegant storytelling pacing.",
    rulesJson: {
  ...
  {
    id: "preset-minimal-authority",
    name: "Minimal Authority",
    description: "Lean, confident presentation built around concise copy, strong whitespace, and sober trust cues.",
    rulesJson: {
  ...
  {
    id: "preset-cinematic-luxury",
    name: "Cinematic Luxury",
    description: "High-drama concepting with premium tension, atmospheric imagery, and immersive hero composition.",
    rulesJson: {
  ...
  {
    id: "preset-bold-modern-contrast",
    name: "Bold Modern Contrast",
    description: "Energetic contemporary layouts that lean on contrast, clear segmentation, and assertive messaging.",
    rulesJson: {
  ...
  {
    id: "preset-structured-professional",
    name: "Structured Professional",
    description: "Reliable, premium B2B structure with clear proof, process, and action flow for service firms.",
    rulesJson: {
